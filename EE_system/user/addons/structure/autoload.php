<?php
/**
 * EEHarbor PHAR Loader for Structure
 ...
 * @link       https://eeharbor.com/structure
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'structure/structure.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/structure';

        $namespace = 'EEHarbor\Structure';
