...
class Low_variables_type {
	...
	const CONTENT_TYPE = 'low_variables';
	...
	public function init($var)
	{
		...
		if ($this->id && ! is_numeric($this->id)) $this->id = NULL;
	...
	protected function call_ft()
	{
		...
		if ( ! is_object($this->_ft) || ! is_callable(array($this->_ft, $fn))) return;
	...
	{
		return sprintf('variable_settings[%s][%s]%s',
			$this->type, $name, $multi ? '[]' : '');
	}
...
// End of file type.low_variables.php
