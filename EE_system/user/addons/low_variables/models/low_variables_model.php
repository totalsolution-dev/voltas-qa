 ...
 */
abstract class Low_variables_model extends CI_Model {
	...
	public function install($autoincrement = TRUE)
	{
		...
		{
			$pk[]   = $this->_pk;
			$rows[] = $this->_pk.' int(10) unsigned NOT NULL' . ($autoincrement ? ' AUTO_INCREMENT' : '');
		}
...
// End of file model.low_variables.php