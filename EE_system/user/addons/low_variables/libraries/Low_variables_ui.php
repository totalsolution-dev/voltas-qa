...
class Low_variables_ui {
	...
	{
		class_alias('Low_variables_ui', 'LVUI');
	}
	...
	{
		$classes = array('low-text-row');
		if (!ee4()) $classes[] = 'txt-wrap';
	...
	{
		return ee('View')->make('low_variables:fields/'.$field)->render($data);
	}
